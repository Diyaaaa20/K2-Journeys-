...
import { FaArrowRight, FaFileAlt, FaCheckCircle, FaClock, FaExclamationCircle, FaGlobeAsia, FaShieldAlt, FaPhoneAlt, FaChevronDown, FaChevronUp, FaUserCircle, FaEnvelope, FaMapMarkerAlt, FaCalendarAlt, FaChevronRight, FaChevronLeft, FaShareAlt, FaLink, FaTimes, FaExternalLinkAlt, FaChartLine, FaBolt } from "react-icons/fa";
...
const ALL_VISAS = [
  { type: "domestic", img: "https://images.unsplash.com/photo-1524492412937-b28074a5d7da?w=600&q=80", flag: "🇮🇳", country: "India (Domestic)", label: "No Visa Required", labelColor: "#00bcd4", labelBg: "#E6F9F9", desc: "Indian citizens only need a valid photo ID for all domestic destinations.", duration: "—", processing: "Instant", fee: "Free", docs: ["Valid Government ID (Aadhar/Passport)", "Booking confirmation"], process: ["Book your trip", "Carry valid ID", "Travel!"], glow: "#00bcd4" },
  { type: "international", img: "https://images.unsplash.com/photo-1528181304800-259b08848526?w=600&q=80", flag: "🇹🇭", country: "Thailand", label: "Visa on Arrival", labelColor: "#FBBF24", labelBg: "#FFFBEB", desc: "Indian passport holders can get a visa on arrival at major Thai airports.", duration: "15 days", processing: "30–60 mins", fee: "₹2,000", docs: ["Valid Passport (6 months validity)", "Passport size photos (2)", "Return flight ticket", "Hotel booking proof", "Foreign currency (₹10,000+)"], process: ["Land at BKK/DMK airport", "Head to VOA counter", "Fill immigration form", "Pay fee in cash", "Get stamp & enter"], glow: "#FBBF24" },
  { type: "international", img: "https://images.unsplash.com/photo-1488085061387-422e29b40080?w=600&q=80", flag: "🇳🇵", country: "Nepal", label: "Visa on Arrival", labelColor: "#FBBF24", labelBg: "#FFFBEB", desc: "Most nationalities can obtain a visa at Tribhuvan Airport or land borders.", duration: "15/30/90 days", processing: "15–30 mins", fee: "$30–$100 USD", docs: ["Valid Passport", "Passport photos (2)", "USD cash for fee", "Return ticket"], process: ["Arrive at Tribhuvan Airport", "Complete online form at kiosk", "Queue at VOA counter", "Pay fee (USD/EUR/INR)", "Collect visa sticker"], glow: "#FBBF24" },
  { type: "international", img: "https://images.unsplash.com/photo-1553428888-9d0d46a3e28d?w=600&q=80", flag: "🇧🇹", country: "Bhutan", label: "Pre-Approved", labelColor: "#F87171", labelBg: "#FEF2F2", desc: "A Bhutan visa must be arranged in advance through an authorized tour operator.", duration: "As per itinerary", processing: "5–7 working days", fee: "₹2,500/day (SDF)", docs: ["Valid Passport (6 months+)", "Visa approval letter from K2 Journeys", "2 passport photos", "Travel insurance"], process: ["Contact K2 Journeys", "We apply on your behalf", "Receive approval letter", "Show letter at border", "Collect visa on arrival"], glow: "#F87171" },
  { type: "international", img: "https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?w=600&q=80", flag: "🇱🇰", country: "Sri Lanka", label: "e-Visa", labelColor: "#A78BFA", labelBg: "#F5F3FF", desc: "Apply online through the official Sri Lanka ETA portal before travel.", duration: "30 days", processing: "24–72 hours", fee: "~$35 USD", docs: ["Valid Passport", "Credit/Debit card", "Return ticket", "Hotel booking"], process: ["Visit eta.gov.lk", "Fill online form", "Pay fee online", "Receive e-visa via email", "Print and carry to airport"], glow: "#A78BFA" },
  { type: "international", img: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=600&q=80", flag: "🇦🇪", country: "UAE (Dubai)", label: "e-Visa", labelColor: "#A78BFA", labelBg: "#F5F3FF", desc: "Apply through travel agencies, airlines, or the official ICP portal.", duration: "14/30/90 days", processing: "3–5 working days", fee: "₹5,000–₹15,000", docs: ["Valid Passport (6 months+)", "Passport photo", "Bank statement (3 months)", "Salary slips / ITR", "Hotel booking", "Return ticket"], process: ["Submit docs to K2 Journeys", "We file via approved channel", "Track status together", "Receive visa via email", "Print visa + travel"], glow: "#A78BFA" },
  { type: "international", img: "https://images.unsplash.com/photo-1525625293386-3f8f99389edd?w=600&q=80", flag: "🇸🇬", country: "Singapore", label: "e-Visa", labelColor: "#A78BFA", labelBg: "#F5F3FF", desc: "Apply online via the ICA Singapore portal. Approval is usually quick for employed applicants.", duration: "30 days", processing: "3–5 working days", fee: "₹2,500–₹4,000", docs: ["Valid Passport (6 months+)", "Passport photo", "Bank statement (3 months)", "Employment proof / ITR", "Hotel booking", "Return ticket"], process: ["Submit documents to K2 Journeys", "We apply via ICA Singapore portal", "Receive approval in-principle", "Get visa label via email", "Travel!"], glow: "#A78BFA" },
  { type: "international", img: "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=600&q=80", flag: "🇲🇻", country: "Maldives", label: "Visa on Arrival", labelColor: "#FBBF24", labelBg: "#FFFBEB", desc: "All nationalities including Indians get a free 30-day visa on arrival at Velana International Airport.", duration: "30 days", processing: "Immediate", fee: "Free", docs: ["Valid Passport (6 months+)", "Return flight ticket", "Hotel / resort booking", "Sufficient funds proof"], process: ["Land at Velana Airport", "Proceed to immigration", "Show booking & return ticket", "Get stamp & enter", "Enjoy the Maldives!"], glow: "#FBBF24" },
  { type: "international", img: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=600&q=80", flag: "🇮🇩", country: "Indonesia (Bali)", label: "Visa on Arrival", labelColor: "#FBBF24", labelBg: "#FFFBEB", desc: "Indians can obtain a Visa on Arrival (e-VOA) at Ngurah Rai International Airport, Bali.", duration: "30 days (extendable)", processing: "30–60 mins", fee: "$35 USD", docs: ["Valid Passport (6 months+)", "Return flight ticket", "Hotel booking", "USD cash or card for fee"], process: ["Arrive at Bali airport", "Head to e-VOA kiosk or counter", "Fill form & pay fee", "Collect VOA sticker", "Proceed to immigration"], glow: "#FBBF24" },
  { type: "international", img: "https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=600&q=80", flag: "🇻🇳", country: "Vietnam", label: "e-Visa", labelColor: "#A78BFA", labelBg: "#F5F3FF", desc: "Apply for a single-entry e-visa through the official Vietnam Immigration portal before travel.", duration: "90 days", processing: "3 working days", fee: "$25 USD", docs: ["Valid Passport (6 months+)", "Passport-size photo", "Credit/Debit card for payment", "Entry & exit date details"], process: ["Visit evisa.xuatnhapcanh.gov.vn", "Fill application form", "Pay $25 fee online", "Receive e-visa via email", "Print & carry to airport"], glow: "#A78BFA" },
  { type: "international", img: "https://images.unsplash.com/photo-1596422846543-75c6fc197f07?w=600&q=80", flag: "🇲🇾", country: "Malaysia", label: "e-NTL (Free)", labelColor: "#00bcd4", labelBg: "#E6F9F9", desc: "Indian passport holders enjoy visa-free entry to Malaysia for up to 30 days under the eNTL scheme.", duration: "30 days", processing: "Instant (pre-register online)", fee: "Free", docs: ["Valid Passport (6 months+)", "eNTL online registration", "Return flight ticket", "Hotel booking", "Sufficient funds"], process: ["Register at eNTL portal", "Receive approval email", "Fly to Malaysia", "Show approval at immigration", "Enter visa-free"], glow: "#00bcd4" },
  { type: "international", img: "https://images.unsplash.com/photo-1542640244-7e672d6cef4e?w=600&q=80", flag: "🇯🇵", country: "Japan", label: "Embassy Visa", labelColor: "#F87171", labelBg: "#FEF2F2", desc: "Japan requires a sticker visa applied through the Japanese Embassy or authorised agents.", duration: "15/30/90 days", processing: "5–7 working days", fee: "₹560 (single) / ₹1,120 (multiple)", docs: ["Valid Passport (6 months+)", "Japan visa application form", "Bank statement (6 months)", "Income tax returns", "Flight & hotel itinerary", "Employment letter"], process: ["Submit docs to K2 Journeys", "We file at Japanese Embassy", "Biometrics if required", "Passport returned with sticker", "Travel to Japan"], glow: "#F87171" },
  { type: "international", img: "https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?w=600&q=80", flag: "🇦🇺", country: "Australia", label: "e-Visa (ETA)", labelColor: "#A78BFA", labelBg: "#F5F3FF", desc: "Apply for a tourist visa (subclass 600) online. Processing times vary based on individual profile.", duration: "Up to 3 months", processing: "15–30 working days", fee: "~₹12,000", docs: ["Valid Passport", "Bank statement (6 months)", "ITR / salary slips", "Property / asset proof", "Travel itinerary", "Cover letter"], process: ["Submit docs to K2 Journeys", "We file online application", "Biometrics at VFS centre", "Await decision (email)", "Receive e-visa grant"], glow: "#A78BFA" },
  { type: "international", img: "https://images.unsplash.com/photo-1499856871958-5b9627545d1a?w=600&q=80", flag: "🇫🇷", country: "Europe (Schengen)", label: "Embassy Visa", labelColor: "#F87171", labelBg: "#FEF2F2", desc: "A Schengen visa allows travel across 27 European countries. Apply at the embassy of your primary destination.", duration: "Up to 90 days", processing: "15 working days", fee: "€85 (~₹7,600)", docs: ["Valid Passport (3 months beyond travel)", "Travel insurance (min €30,000)", "Bank statement (6 months)", "ITR / salary proof", "Hotel & flight bookings", "Cover letter"], process: ["Choose primary country embassy", "Submit docs via K2 Journeys", "Biometrics at VFS Global", "Wait for decision", "Collect passport with visa"], glow: "#F87171" },
  { type: "international", img: "https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?w=600&q=80", flag: "🇹🇷", country: "Turkey", label: "e-Visa", labelColor: "#A78BFA", labelBg: "#F5F3FF", desc: "Indian passport holders can apply for a Turkey e-Visa online through the official portal before travel.", duration: "30 days", processing: "24–72 hours", fee: "~$55 USD", docs: ["Valid Passport (6 months+)", "Credit/Debit card for payment", "Return flight ticket", "Hotel booking confirmation"], process: ["Visit evisa.gov.tr", "Fill online application", "Pay fee online (~$55)", "Receive e-visa via email", "Print & carry to airport"], glow: "#A78BFA" },
];

const STEPS = [
  { num: "01", icon: FaFileAlt, color: "#00bcd4", bg: "#E6F9F9", title: "Share Your Itinerary", desc: "Tell us where you're going and when. Our visa team reviews requirements for your nationality." },
  { num: "02", icon: FaCheckCircle, color: "#FBBF24", bg: "#FFFBEB", title: "Document Checklist", desc: "We send a precise list — passport, photos, bank statements, and more." },
  { num: "03", icon: FaGlobeAsia, color: "#A78BFA", bg: "#F5F3FF", title: "We File the Application", desc: "Our team handles the entire submission, whether e-visa, embassy, or consulate." },
  { num: "04", icon: FaBolt, color: "#F87171", bg: "#FEF2F2", title: "Visa in Hand", desc: "We notify you the moment your visa is approved and walk you through what to carry." },
];
...
function StatCounter({ value, suffix, label, start }) {
  ...
  return (
    <div style={{ textAlign: "center" }}>
      <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 44, fontWeight: 700, color: "#00bcd4", lineHeight: 1 }}>{count.toLocaleString()}{suffix}</div>
    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#fff", color: "#1A1A2E", overflowX: "hidden" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        input:focus, select:focus { outline: 2px solid #00bcd4; }
        ...
        .k2-visa-sticky { position: sticky; top: 88px; }
        @media (max-width: 1024px) { .k2-visa-sticky { position: static; } }
      `}</style>
      ...
      <header style={{ position: "sticky", top: 0, zIndex: 100, background: "#fff", boxShadow: "0 2px 16px rgba(0,0,0,0.07)", padding: "0 48px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 68 }}>
        ...
        <button style={{ background: "#00bcd4", color: "#fff", fontWeight: 700, fontSize: 14, padding: "10px 22px", borderRadius: 24, display: "flex", alignItems: "center", gap: 8 }}>
      ...
      <section style={{ minHeight: 400, padding: "72px 64px 60px", backgroundImage: "linear-gradient(105deg,rgba(255,255,255,0.97) 38%,rgba(255,255,255,0.6) 65%,rgba(255,255,255,0.05) 100%),url('https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=1600&q=80')", backgroundSize: "cover", backgroundPosition: "center", display: "flex", justifyContent: "space-between", gap: 48, alignItems: "center" }}>
        <div style={{ maxWidth: 520, animation: "fadeUp 0.8s ease both" }}>
          <p style={{ color: "#00bcd4", fontSize: 12.5, fontWeight: 700, letterSpacing: 3, marginBottom: 16 }}>— VISA ASSISTANCE</p>
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 48, fontWeight: 700, lineHeight: 1.18, color: "#0D1321", marginBottom: 20 }}>
            Visas made simple,<br /><span style={{ color: "#00bcd4", fontStyle: "italic" }}>so you can just go.</span>
          </h1>
          ...
          <div style={{ display: "flex", gap: 14 }}>
            <button style={{ background: "#00bcd4", color: "#fff", fontWeight: 700, fontSize: 14, padding: "13px 28px", borderRadius: 24, display: "flex", alignItems: "center", gap: 8, boxShadow: "0 4px 16px rgba(10,191,188,0.3)", transition: "transform 0.2s" }} onMouseEnter={e => e.currentTarget.style.transform = "translateY(-2px)"} onMouseLeave={e => e.currentTarget.style.transform = ""}>
              Get Visa Help <FaArrowRight size={15} />
            </button>
            <button style={{ background: "transparent", color: "#0D1321", fontWeight: 600, fontSize: 14, padding: "13px 28px", borderRadius: 24, border: "1.5px solid #D1D5DB", display: "flex", alignItems: "center", gap: 8, transition: "all 0.2s" }} onMouseEnter={e => { e.currentTarget.style.borderColor = "#00bcd4"; e.currentTarget.style.color = "#00bcd4"; }} onMouseLeave={e => { e.currentTarget.style.borderColor = "#D1D5DB"; e.currentTarget.style.color = "#0D1321"; }}>
              Check Requirements <FaGlobeAsia size={15} />
            </button>
          </div>
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: 14, animation: "fadeUp 0.8s ease 0.15s both" }}>
          {[{ icon: FaCheckCircle, color: "#00bcd4", bg: "#E6F9F9", title: "99% Approval Rate", desc: "Correctly filed applications, every time." }, { icon: FaClock, color: "#FBBF24", bg: "#FFFBEB", title: "Fast Processing", desc: "We submit within 24 hours of receiving your docs." }, { icon: FaShieldAlt, color: "#A78BFA", bg: "#F5F3FF", title: "Secure & Private", desc: "Your documents handled with complete confidentiality." }].map((b) => (
      ...
      <section style={{ background: "linear-gradient(135deg, #0D1321 0%, #1a2744 50%, #0D1321 100%)", padding: "64px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", display: "flex", gap: 40, alignItems: "center" }}>
          <div style={{ flex: 1 }}>
            <p style={{ color: "#00bcd4", fontSize: 12.5, fontWeight: 700, letterSpacing: 3, marginBottom: 14 }}>WHY CHOOSE K2 VISA SERVICES</p>
      ...
      <section style={{ background: "#F9FAFB", padding: "80px 64px" }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <p style={{ color: "#00bcd4", fontSize: 12.5, fontWeight: 700, letterSpacing: 3, marginBottom: 14 }}>DESTINATION VISA GUIDE</p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
          {ALL_VISAS.map((v, i) => (
            <div
              key={v.country}
              style={{ position: "relative", animation: `fadeUp 0.5s ease ${i * 0.07}s both` }}
            >
              {/* ── Boarding-pass notch cutouts ── */}
              <div style={{ position: "absolute", left: -11, top: 185, transform: "translateY(-50%)", width: 22, height: 22, borderRadius: "50%", background: "#F9FAFB", border: "1.5px solid #E5E7EB", zIndex: 10, pointerEvents: "none" }} />
              <div style={{ position: "absolute", right: -11, top: 185, transform: "translateY(-50%)", width: 22, height: 22, borderRadius: "50%", background: "#F9FAFB", border: "1.5px solid #E5E7EB", zIndex: 10, pointerEvents: "none" }} />
              ...
              <div
                ...
                style={{
                  background: "#fff",
                  border: hoveredCard === i ? "2.5px solid #A78BFA" : "1.5px solid #E5E7EB",
                  borderRadius: 20,
                  overflow: "hidden",
                  boxShadow: hoveredCard === i ? "0 0 25px rgba(167,139,250,0.45), 0 12px 35px rgba(167,139,250,0.18)" : "0 8px 22px rgba(15,23,42,0.08)",
              ...
              >
                ...
                <div style={{ position: "relative", height: 185, overflow: "hidden" }}>
                  <img src={v.img} alt={v.country} style={{ width: "100%", height: "100%", objectFit: "cover", transform: hoveredCard === i ? "scale(1.09)" : "scale(1)", transition: "transform 0.55s ease", display: "block" }} />
                  <div style={{ position: "absolute", inset: 0, background: "linear-gradient(transparent 30%, rgba(10,15,28,0.78) 100%)" }} />
                  <div style={{ position: "absolute", bottom: 14, left: 16, display: "flex", alignItems: "center", gap: 9 }}>
                    <span style={{ fontSize: 26, lineHeight: 1, filter: "drop-shadow(0 1px 4px rgba(0,0,0,0.6))" }}>{v.flag}</span>
                    <h4 style={{ color: "#fff", fontSize: 16, fontWeight: 700, textShadow: "0 1px 6px rgba(0,0,0,0.6)", margin: 0 }}>{v.country}</h4>
                  </div>
                  <span style={{ position: "absolute", top: 12, right: 12, background: v.labelBg, color: v.labelColor, fontSize: 11, fontWeight: 700, padding: "5px 11px", borderRadius: 10, boxShadow: "0 2px 8px rgba(0,0,0,0.15)", backdropFilter: "blur(4px)" }}>{v.label}</span>
                </div>

                {/* ── Boarding-pass tear-off line ── */}
                ...
                <div style={{ padding: "18px 22px 22px" }}>
                  <p style={{ fontSize: 13, color: "#6B7280", lineHeight: 1.65, marginBottom: 14 }}>{v.desc}</p>
                  <div style={{ borderTop: "1px solid #F3F4F6", paddingTop: 12, display: "flex", flexDirection: "column", gap: 7, marginBottom: 14 }}>
                    {[["Duration", v.duration], ["Processing", v.processing], ["Approx. Fee", v.fee]].map(([k, val]) => (
                      <div key={k} style={{ display: "flex", justifyContent: "space-between" }}>
                        ...
                        <span style={{ fontSize: 12.5, color: "#0D1321", fontWeight: 700 }}>{val}</span>
                      </div>
                    ))}
                  </div>
                  <button style={{ width: "100%", background: "#A78BFA", color: "#fff", fontWeight: 600, fontSize: 13.5, padding: "11px", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, transition: "all 0.3s ease", border: "1px solid #A78BFA", boxShadow: hoveredCard === i ? "0 0 20px rgba(167,139,250,0.8)" : "0 4px 12px rgba(167,139,250,0.35)" }}>
                    View Full Details <FaExternalLinkAlt size={13} />
                  </button>
                </div>
              </div>
            </div>
      ...
      <section style={{ padding: "0 64px 48px" }}>
        <div style={{ background: "#FFFBEB", border: "1px solid #FDE68A", borderRadius: 16, padding: "20px 24px", display: "flex", gap: 14, alignItems: "flex-start" }}>
          <FaExclamationCircle size={20} color="#F59E0B" style={{ flexShrink: 0, marginTop: 2 }} />
      ...
      {/* ── HOW IT WORKS (interactive animated process) ── */}
      <section ref={processRef} style={{ padding: "80px 64px" }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          <p style={{ color: "#00bcd4", fontSize: 12.5, fontWeight: 700, letterSpacing: 3, marginBottom: 14 }}>THE PROCESS</p>
        ...
        <div style={{ display: "flex", gap: 0, position: "relative", alignItems: "flex-start" }}>
          ...
          {/* Connector lines drawn between circle centers */}
          {STEPS.slice(0, -1).map((s, i) => (
            <div
              key={`line-${i}`}
              style={{
                position: "absolute",
                top: 27,                          /* half of circle height (56/2) - half of line height (3/2) */
                left: `calc(${(i + 1) / STEPS.length * 100}% - ${100 / STEPS.length / 2}% + 28px)`,
                width: `calc(${100 / STEPS.length}% - 56px)`,
                height: 3,
                background: "#E5E7EB",
                borderRadius: 2,
                overflow: "hidden",
        ...
        <div style={{ textAlign: "center", marginTop: 40 }}>
          <div style={{ display: "inline-flex", gap: 10 }}>
            <button onClick={() => setActiveStep(s => Math.max(0, s - 1))} style={{ width: 36, height: 36, borderRadius: "50%", background: "#00bcd4", color: "#fff", border: "none", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}><FaChevronLeft size={16} color="#fff" /></button>
            <button onClick={() => setActiveStep(s => Math.min(STEPS.length - 1, s + 1))} style={{ width: 36, height: 36, borderRadius: "50%", background: "#00bcd4", color: "#fff", border: "none", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}><FaChevronRight size={16} /></button>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: "#F9FAFB", padding: "80px 64px" }}>
        <div style={{ display: "flex", gap: 56, alignItems: "flex-start" }}>
          <div style={{ flex: 1 }}>
            <p style={{ color: "#00bcd4", fontSize: 12.5, fontWeight: 700, letterSpacing: 3, marginBottom: 14 }}>FAQ</p>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {FAQS.map((f, i) => (
                <div key={i} style={{ background: "#fff", border: `1.5px solid ${openFaq === i ? "#00bcd444" : "#E5E7EB"}`, borderRadius: 14, overflow: "hidden", boxShadow: openFaq === i ? "0 4px 20px rgba(10,191,188,0.1)" : "0 1px 6px rgba(0,0,0,0.04)", transition: "all 0.3s" }}>
                  <button onClick={() => setOpenFaq(openFaq === i ? null : i)} style={{ width: "100%", padding: "18px 20px", display: "flex", justifyContent: "space-between", alignItems: "center", background: "transparent", fontWeight: 600, fontSize: 15, color: openFaq === i ? "#00bcd4" : "#0D1321", textAlign: "left", transition: "color 0.3s" }}>
                    {f.q}
                    <span style={{ transition: "transform 0.3s", transform: openFaq === i ? "rotate(180deg)" : "rotate(0)" }}>
                      {openFaq === i ? <FaChevronUp size={18} color="#00bcd4" /> : <FaChevronDown size={18} color="#9CA3AF" />}
                    </span>
                  </button>
            ...
            {/* CTA after FAQ */}
            <div style={{ marginTop: 32, background: "linear-gradient(135deg, #00bcd4, #0891b2)", borderRadius: 18, padding: "28px 28px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 20, animation: "fadeUp 0.6s ease both" }}>
              <div>
              ...
              <div style={{ display: "flex", gap: 10, flexShrink: 0 }}>
                <button style={{ background: "#fff", color: "#00bcd4", fontWeight: 700, fontSize: 13.5, padding: "12px 20px", borderRadius: 20, display: "flex", alignItems: "center", gap: 8 }}>Contact Us <FaArrowRight size={13} /></button>
                <button style={{ background: "rgba(255,255,255,0.15)", color: "#fff", fontWeight: 700, fontSize: 13.5, padding: "12px 20px", borderRadius: 20, border: "1px solid rgba(255,255,255,0.3)", display: "flex", alignItems: "center", gap: 8 }}>Start Planning <FaBolt size={13} /></button>
              </div>
            </div>
          </div>

          <div className="k2-visa-sticky" style={{ width: 380, flexShrink: 0, background: "#fff", borderRadius: 20, padding: "32px 30px", border: "1px solid #E5E7EB", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
              <FaFileAlt size={22} color="#00bcd4" />
              <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, fontWeight: 700, color: "#0D1321" }}>Quick Visa Enquiry</h3>
            </div>
            <div style={{ width: 44, height: 3, background: "#00bcd4", marginBottom: 24 }} />
      ...
      {selectedVisa && (
        <div onClick={() => setSelectedVisa(null)} style={{ position: "fixed", inset: 0, background: "rgba(13,19,33,0.7)", zIndex: 999, display: "flex", alignItems: "center", justifyContent: "center", backdropFilter: "blur(4px)", animation: "popIn 0.3s ease" }}>
          <div onClick={e => e.stopPropagation()} style={{ background: "#fff", borderRadius: 24, padding: "40px", width: "min(680px, 95vw)", maxHeight: "85vh", overflowY: "auto", position: "relative", animation: "popIn 0.3s ease" }}>
            <button onClick={() => setSelectedVisa(null)} style={{ position: "absolute", top: 20, right: 20, width: 36, height: 36, borderRadius: "50%", background: "#0D1321", color: "#fff", border: "none", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}><FaTimes size={16} color="#fff" /></button>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
              <div>
                <h4 style={{ fontSize: 16, fontWeight: 700, color: "#0D1321", marginBottom: 14, display: "flex", alignItems: "center", gap: 8 }}><FaCheckCircle size={16} color="#00bcd4" /> Required Documents</h4>
                  ...
                  {selectedVisa.docs.map((d, i) => (
                    <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                      <div style={{ width: 20, height: 20, borderRadius: "50%", background: "#E6F9F9", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: 1 }}>
                        <span style={{ fontSize: 11, fontWeight: 700, color: "#00bcd4" }}>{i + 1}</span>
                      </div>
              ...
              <div>
                <h4 style={{ fontSize: 16, fontWeight: 700, color: "#0D1321", marginBottom: 14, display: "flex", alignItems: "center", gap: 8 }}><FaArrowRight size={16} color="#00bcd4" /> Application Process</h4>
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {selectedVisa.process.map((p, i) => (
                    <div key={i} style={{ display: "flex", alignItems: "center", gap: 10 }}>
                      <div style={{ width: 24, height: 24, borderRadius: "50%", background: "#00bcd4", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            ...
            <button onClick={() => setSelectedVisa(null)} style={{ width: "100%", marginTop: 28, background: "#00bcd4", color: "#fff", fontWeight: 700, fontSize: 15, padding: "14px", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
              Get Help With This Visa <FaArrowRight size={16} />
            </button>
          </div>
        </div>
      )}
