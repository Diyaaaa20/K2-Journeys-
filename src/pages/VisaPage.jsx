...
const STEPS = [
  { num: "01", icon: FileText, color: "#00bcd4", bg: "#E6F9F9", title: "Share Your Itinerary", desc: "Tell us where you're going and when. Our visa team reviews requirements for your nationality." },
      ...
      <section style={{ background: "#F9FAFB", padding: "80px 64px" }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <div style={{ display: "inline-flex", background: "#fff", borderRadius: 28, border: "1.5px solid #E5E7EB", padding: 4, gap: 4, boxShadow: "0 2px 10px rgba(0,0,0,0.06)" }}>
            {[
              { val: "all", label: "All Destinations", prefix: null },
              { val: "domestic", label: "Domestic", prefix: "🇮🇳" },
              { val: "international", label: "International", prefix: "plane" },
            ].map(({ val, label, prefix }) => (
              <button key={val} onClick={() => setFilter(val)} style={{ padding: "10px 22px", borderRadius: 22, fontSize: 14, fontWeight: 600, background: filter === val ? "#00bcd4" : "transparent", color: filter === val ? "#fff" : "#374151", transition: "all 0.25s", boxShadow: filter === val ? "0 4px 14px rgba(10,191,188,0.3)" : "none", display: "flex", alignItems: "center", gap: 7 }}>
                {prefix === "plane" ? <Plane size={14} /> : prefix && <span>{prefix}</span>}
                {label}
              </button>
            ))}
          </div>
            ...
            >
              ...
              <div style={{ position: "relative", height: 185, overflow: "hidden" }}>
                <img
                  src={v.img}
                  alt={v.country}
                  style={{ width: "100%", height: "100%", objectFit: "cover", transform: hoveredCard === i ? "scale(1.09)" : "scale(1)", transition: "transform 0.55s ease", display: "block" }}
                />
      ...
      <section ref={processRef} style={{ padding: "80px 64px" }}>
        ...
        <div style={{ textAlign: "center", marginTop: 40 }}>
          <div style={{ display: "inline-flex", gap: 10 }}>
            <button onClick={() => setActiveStep(s => Math.max(0, s - 1))} style={{ width: 36, height: 36, borderRadius: "50%", background: "#00bcd4", color: "#fff", border: "none", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}><ChevronLeft size={16} color="#fff" /></button>
            <button onClick={() => setActiveStep(s => Math.min(STEPS.length - 1, s + 1))} style={{ width: 36, height: 36, borderRadius: "50%", background: "#00bcd4", color: "#fff", border: "none", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}><ChevronRight size={16} /></button>
          </div>
        </div>
      </section>
          ...
          <div style={{ flex: 1 }}>
                ...
                <div key={i} style={{ background: "#fff", border: `1.5px solid ${openFaq === i ? "#00bcd444" : "#E5E7EB"}`, borderRadius: 14, overflow: "hidden", boxShadow: openFaq === i ? "0 4px 20px rgba(10,191,188,0.1)" : "0 1px 6px rgba(0,0,0,0.04)", transition: "all 0.3s" }}>
                  <button onClick={() => setOpenFaq(openFaq === i ? null : i)} style={{ width: "100%", padding: "18px 20px", display: "flex", justifyContent: "space-between", alignItems: "center", background: "transparent", fontWeight: 600, fontSize: 15, color: openFaq === i ? "#00bcd4" : "#0D1321", textAlign: "left", transition: "color 0.3s" }}>
                    ...
                    <span style={{ transition: "transform 0.3s", transform: openFaq === i ? "rotate(180deg)" : "rotate(0)" }}>
                      {openFaq === i ? <ChevronUp size={18} color="#00bcd4" /> : <ChevronDown size={18} color="#9CA3AF" />}
                    </span>
                  </button>
            ...
            <div style={{ marginTop: 32, background: "linear-gradient(135deg, #00bcd4, #0891b2)", borderRadius: 18, padding: "28px 28px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 20, animation: "fadeUp 0.6s ease both" }}>
              ...
              <div style={{ display: "flex", gap: 10, flexShrink: 0 }}>
                <button style={{ background: "#fff", color: "#00bcd4", fontWeight: 700, fontSize: 13.5, padding: "12px 20px", borderRadius: 20, display: "flex", alignItems: "center", gap: 8 }}>Contact Us <ArrowRight size={13} /></button>
      ...
      {selectedVisa && (
        <div onClick={() => setSelectedVisa(null)} style={{ position: "fixed", inset: 0, background: "rgba(13,19,33,0.7)", zIndex: 999, display: "flex", alignItems: "center", justifyContent: "center", backdropFilter: "blur(4px)", animation: "popIn 0.3s ease" }}>
          <div onClick={e => e.stopPropagation()} style={{ background: "#fff", borderRadius: 24, padding: "40px", width: "min(680px, 95vw)", maxHeight: "85vh", overflowY: "auto", position: "relative", animation: "popIn 0.3s ease" }}>
            <button onClick={() => setSelectedVisa(null)} style={{ position: "absolute", top: 20, right: 20, width: 36, height: 36, borderRadius: "50%", background: "#0D1321", color: "#fff", border: "none", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}><X size={16} color="#fff" /></button>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
              <div>
                <h4 style={{ fontSize: 16, fontWeight: 700, color: "#0D1321", marginBottom: 14, display: "flex", alignItems: "center", gap: 8 }}><CheckCircle size={16} color="#00bcd4" /> Required Documents</h4>
              ...
              <div>
                <h4 style={{ fontSize: 16, fontWeight: 700, color: "#0D1321", marginBottom: 14, display: "flex", alignItems: "center", gap: 8 }}><ArrowRight size={16} color="#00bcd4" /> Application Process</h4>
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
